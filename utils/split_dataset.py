...
if __name__ == '__main__':
    ...
    # 保存为JSON文件
    output_file = os.path.join(root_dir,  'data_splits_pre_experiment.json')
    ...
    save_to_file(os.path.join(root_dir, 'train.csv'), data_splits['train'])
    save_to_file(os.path.join(root_dir, 'valid.csv'), data_splits['val'])
    save_to_file(os.path.join(root_dir, 'test.csv'), data_splits['test'])
